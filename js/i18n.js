  ...
  de: {
    ...
    progress: {
      ...
      readiness: {
        ...
        zoneExhausted: 'Erschöpft',
        zoneFatigued: 'Ermüdet',
        zoneLoaded: 'Belastet',
        zoneReady: 'Bereit',
        zoneFresh: 'Frisch',
        buildingBaseline: 'Baseline wird aufgebaut',
        infoTitle: 'Was ist Trainingsbereitschaft?',
        infoBody: 'Trainingsbereitschaft schätzt, wie gut dein Körper auf hartes Training vorbereitet ist.',
        infoCompare: 'Sie vergleicht:',
        infoRecent: 'Deine aktuelle Trainingsbelastung (letzte Tage)',
        infoLongTerm: 'Dein langfristiges Trainingsniveau (letzte Wochen)',
        infoHighLoad: 'Wenn deine aktuelle Belastung deutlich höher ist als üblich → die Bereitschaft sinkt.',
        infoLowLoad: 'Wenn deine aktuelle Belastung niedriger ist als üblich → die Bereitschaft steigt.',
        infoGoalNote: 'Das Ziel ist nicht, immer „Frisch" zu sein. Das Ziel ist, meistens in den mittleren Zonen zu bleiben.',
        loadRatioLabel: 'Belastungsverhältnis',
        zoneDescExhausted: 'Sehr hohe aktuelle Belastung. Erholung in Betracht ziehen.',
        zoneDescFatigued: 'Belastung ist erhöht. Trainiere klug.',
        zoneDescLoaded: 'Produktive Trainingsphase.',
        zoneDescReady: 'Gute Balance zwischen Belastung und Erholung.',
        zoneDescFresh: 'Niedrige aktuelle Belastung. Guter Zeitpunkt für Intensität.',
  ...
  en: {
    ...
    progress: {
      ...
      readiness: {
        ...
        zoneExhausted: 'Exhausted',
        zoneFatigued: 'Fatigued',
        zoneLoaded: 'Loaded',
        zoneReady: 'Ready',
        zoneFresh: 'Fresh',
        buildingBaseline: 'Building baseline',
        infoTitle: 'What is Training Readiness?',
        infoBody: 'Training Readiness estimates how prepared your body is for hard training.',
        infoCompare: 'It compares:',
        infoRecent: 'Your recent training load (last days)',
        infoLongTerm: 'Your longer-term training level (last weeks)',
        infoHighLoad: 'If your recent load is much higher than usual → readiness drops.',
        infoLowLoad: 'If your recent load is lower than usual → readiness rises.',
        infoGoalNote: 'The goal is not to always be "Fresh". The goal is to stay mostly in the middle zones.',
        loadRatioLabel: 'Load Ratio',
        zoneDescExhausted: 'Very high recent load. Consider recovery.',
        zoneDescFatigued: 'Load is elevated. Train smart.',
        zoneDescLoaded: 'Productive training phase.',
        zoneDescReady: 'Good balance between stress and recovery.',
        zoneDescFresh: 'Low recent load. Good time for intensity.',
